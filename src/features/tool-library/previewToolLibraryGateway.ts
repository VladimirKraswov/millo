...
let snapshot: ToolLibraryState = {
  ...
  tools: [
    ...
    {
      ...tool("preset-measured-4f-d6-5-l34-oal75", "Концевая длинная 4-зубая 6,5 мм · 6,5×34×75", "flatEndMill", 6.5, 6.5, undefined, "Длинная четырёхзубая концевая фреза без читаемого артикула. Перед глубоким проходом измерьте рабочую длину и хвостовик; стартовые режимы намеренно занижены."),
      cuttingLengthMm: 34,
      fluteCount: 4,
      feedMmPerMin: 300,
      plungeMmPerMin: 60,
