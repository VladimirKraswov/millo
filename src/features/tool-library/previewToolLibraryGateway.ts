...
let snapshot: ToolLibraryState = {
  ...
  tools: [
    ...
    {
      ...tool("preset-generic-blue-engraver-0-2", "Конический гравёр 0,2 мм · комплект CNC 3018", "engraving", 3.175, 3.175, undefined, "Комплектный конический гравёр 3,175×0,2×40 мм. Перед точным PCB CAM укажите угол по маркировке колпачка."),
      tipDiameterMm: 0.2,
      cuttingLengthMm: 3,
      fluteCount: 1,
      feedMmPerMin: 240,
      ...
      reference: {
        manufacturer: "Без маркировки производителя",
        product: "Конический гравёр 3,175×0,2×40",
        url: "https://www.stankoff.ru/category/1047/odnozahodnyie-konicheskie-gravery",
      },
    },
    {
      ...tool("preset-xc-nlj3-2001", "Гравёр 20° × 0,1 мм · XC-NLJ3.2001", "engraving", 3.175, 3.175, 20, "Точный V-гравёр с кончиком 0,1 мм и общей длиной 40 мм. Пресет ограничивает не указанную на футляре рабочую длину консервативными 3 мм."),
      tipDiameterMm: 0.1,
      cuttingLengthMm: 3,
      fluteCount: 1,
      feedMmPerMin: 300,
    ...
    {
      ...tool("preset-v-engraver-90-0-1", "V-гравёр 90° × 0,1 мм", "engraving", 3.175, 3.175, 90, "V-гравёр для широких неглубоких канавок, надписей и фасок. Перед работой проверьте кромки и рабочую длину: на футляре указан только угол и кончик."),
      tipDiameterMm: 0.1,
      cuttingLengthMm: 14,
      feedMmPerMin: 180,
      plungeMmPerMin: 50,
